...
function Contact() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.post("https://getform.io/f/aqondvma", userInfo);
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center mt-5">
          <form
            ...
            className="bg-slate-200 dark:bg-gray-800 w-96 px-8 py-6 rounded-xl shadow-md"
          >
            ...
            <button
              type="submit"
              className="bg-black text-white dark:bg-gray-600 dark:hover:bg-gray-500 rounded-xl px-3 py-2 hover:bg-slate-700 duration-300"
            >
              Send
            </button>
          </form>
